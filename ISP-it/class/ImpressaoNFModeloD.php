<?
	...
	# Ultima alteração: 04/10/2007															#
	# Alteração No.: 001																	#
	#																						#
	# Função:																				#
	#    Impressão Nota Fiscal - Classe para modelo de impressão de nota fiscal modelo D	#
	#########################################################################################
class ImpressaoNFModeloD extends ImpressaoNF {
	...
	*/
	function ImpressaoNFModeloD( $obj ){
		...
		$this->saltoDetalhe = 1; 
		$this->saltoRodape = 3; //valor original 4
		$this->totalItens = 0;
