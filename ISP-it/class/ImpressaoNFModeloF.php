<?
	...
	#																						#
	# Função:																				#
	#    Impressão Nota Fiscal - Classe para modelo de impressão de nota fiscal modelo F	#
	#########################################################################################
class ImpressaoNFModeloF extends ImpressaoNF {
	...
	*/
	function ImpressaoNFModeloF( $obj ){
