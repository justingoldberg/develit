<?php
/** $Id: HTML_ToPDF.php,v 1.2 2005-11-25 19:40:05 gustavo Exp $ */
// {{{ license
...
class HTML_ToPDF {
    ...
    function convert()
    {
        ...
        if (!@is_writable($a_tmpFiles['config'])) {
            return new HTML_ToPDFException("Error: the tmp directory is not writable". $a_tmpFiles['config']);
        }
