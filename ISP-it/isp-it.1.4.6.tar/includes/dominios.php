		...
		novaTabela2("[Adicionar]", "center", '100%', 0, 2, 1, $corFundo, $corBorda, 2);
			...
			fechaLinhaTabela();
				...
				htmlAbreColuna('40%', 'right', $corFundo, 0, 'tabfundo1');
					...
					<span class=normal10>Considerar domínio como padrão</span>";
				htmlFechaColuna();
...
function verDominios($modulo, $sub, $acao, $registro, $matriz) {
	...
	novaTabela2('Informações sobre Domínio', 'center', '100%', 0, 2, 1, $corFundo, $corBorda, 2);
...
# Função para campo select de dominios
...
/**
 *      Seleciona todos os domínios de determinado cliente e retorna o
 * idDominio, idServicosPlanos, status e nome do dominio, concatenados
 * em um array, separados por ":" em cada índice.
 *
