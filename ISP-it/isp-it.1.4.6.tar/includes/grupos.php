...
#
# Função:
#    Funções de grupos de usuarios

# Menu principal de grupos
# Função para cadastro de grupos
		...
		novaTabela2("[Cadastro de Grupos]", "center", '100%', 0, 3, 1, $corFundo, $corBorda, 4);
			novaLinhaTabela($corFundo, '100%');
				htmlAbreColuna('65%', 'left', $corFundo, 0, 'tabfundo1');
					...
					<br><span class=normal10>O cadastro de grupos provê o controle de grupos e limitações
					de acesso, para usuários de grupos.</span>";
				htmlFechaColuna();			
...
function verStatusGrupos()
{
	...
	novaTabela2("[Informações sobre Cadastro de Grupos]", "center", '100%', 0, 2, 1, $corFundo, $corBorda, 3);
		novaLinhaTabela($corFundo, '100%');
			...
			<span class=normal10>Status e informações sobre o cadastro de grupos.";
			htmlFechaColuna();
...
function adicionarGrupos($modulo, $sub, $acao, $registro, $matriz)
{
	...
	if(!$matriz[bntAdicionar]) {
		...
		novaTabela2("[Adicionar]", "center", '100%', 0, 2, 1, $corFundo, $corBorda, 2);
			...
			fechaLinhaTabela();
			novaLinhaTabela($corFundo, '100%');
				itemLinhaForm('<b>Permissões</b>', 'center', 'top', $corFundo, 2, 'tabfundo1');
			fechaLinhaTabela();
			novaLinhaTabela($corFundo, '100%');
				htmlAbreColuna('40%', 'right', $corFundo, 0, 'tabfundo1');
			...
			novaLinhaTabela($corFundo, '100%');
				...
				htmlFechaColuna();
				$texto="<input type=checkbox name=matriz[incluir] value=S><span class=normal10>(Acesso a Inclusão)</span>";
				itemLinhaForm($texto, 'left', 'top', $corFundo, 0, 'tabfundo1');
			fechaLinhaTabela();
			novaLinhaTabela($corFundo, '100%');
				htmlAbreColuna('40%', 'right', $corFundo, 0, 'tabfundo1');
				...
				htmlFechaColuna();
				$texto="<input type=checkbox name=matriz[alterar] value=S><span class=normal10>(Acesso Alteração)</span>";
				itemLinhaForm($texto, 'left', 'top', $corFundo, 0, 'tabfundo1');
			fechaLinhaTabela();
			novaLinhaTabela($corFundo, '100%');
				htmlAbreColuna('40%', 'right', $corFundo, 0, 'tabfundo1');
				...
				htmlFechaColuna();
				$texto="<input type=checkbox name=matriz[excluir] value=S><span class=normal10>(Acesso Exclusão)</span>";
				itemLinhaForm($texto, 'left', 'top', $corFundo, 0, 'tabfundo1');
			fechaLinhaTabela();
			novaLinhaTabela($corFundo, '100%');
				htmlAbreColuna('40%', 'right', $corFundo, 0, 'tabfundo1');
				...
				htmlFechaColuna();
				$texto="<input type=checkbox name=matriz[visualizar] value=S><span class=normal10>(Acesso a Visualização de Detalhes)</span>";
				itemLinhaForm($texto, 'left', 'top', $corFundo, 0, 'tabfundo1');
			fechaLinhaTabela();
			novaLinhaTabela($corFundo, '100%');
				htmlAbreColuna('40%', 'right', $corFundo, 0, 'tabfundo1');
...
function listarGrupos($modulo, $sub, $acao, $registro, $matriz)
{
	...
	novaTabela("[Listar]", "center", '100%', 0, 2, 1, $corFundo, $corBorda, 10);
		...
		if(!$consulta || contaConsulta($consulta)==0) {
			# Não há registros
			itemTabelaNOURL('Não há registros cadastrados', 'left', $corFundo, 10, 'txtaviso');
		}
		else {
			...
			while($i < contaConsulta($consulta) && $i < $limite) {
				...
				$opcoes.="&nbsp;";
				$opcoes.=htmlMontaOpcao("<a href=?modulo=$modulo&sub=$sub&acao=usuarios&registro=$id>Usuários</a>",'usuario');
...
function verGrupo($registro)
{
	...
	novaTabela2('Informações sobre Grupo', 'center', '100%', 0, 2, 1, $corFundo, $corBorda, 2);
		...
		if($admin) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Administrador:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($admin, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($incluir) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Inclusão:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($incluir, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($excluir) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Exclusão:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($excluir, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($alterar) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Alteração:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($alterar, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($visualizar) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Visualizar Detalhes:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($visualizar, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($abrir) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Abrir Tickets:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($abrir, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($fechar) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Fechar Tickets:</b>', 'right', '30%', 'tabfundo1');
				itemLinhaNOURL($fechar, 'left', $corFundo, 0, 'normal');
			fechaLinhaTabela();
		}
		if($comentar) {
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Permissão de Comentar:</b>', 'right', '30%', 'tabfundo1');
		...
		if($consultaUsuariosGrupos && contaConsulta($consultaUsuariosGrupos)>0) {
			...
			# mostrar lista de usuarios
			novaLinhaTabela($corFundo, '100%');
				itemLinhaTabela('<b>Usuários do Grupo:</b>', 'right', '30%', 'tabfundo1');
